...
<script src="<?php echo  base_url() ?>scriptjs/solicitudes/solicitudesReserva.js"></script>
<style>
...
<h1 class="page-title">LISTA DE MATERIALES PARA REALIZAR LA PRE RESERVA DE ALMACEN</h1>
<div class="card"  >
    <div class="card-body">
        <div class="col-12">
...
<br>
<h1 class="page-title">LISTA DE MATERIALES RESERVADOS PARA SU DISPOSICIÓN EN ALMACEN</h1>
<div class="card"  >
    <div class="card-body">
        <div class="col-12">
    ...
    <div class="modal-dialog" style="max-width: 800px;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="exampleModalLabel"><b>Seleccionar la cantidad a Reservar</b></h3>
