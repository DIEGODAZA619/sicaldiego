...
<script src="<?php echo  base_url() ?>scriptjs/solicitudes/entregaSolicitud.js"></script>
<style>
.btn-circle {
    width: 30px;
    height: 30px;
...
<h1 class="page-title">LISTA DE SOLICITUDES AUTORIZADOS</h1>
...
<h1 class="page-title">LISTA DE MATERIALES SOLICITADOS POR DIRECCIÓN PENDIENTES DE ENTREGA</h1>
<div class="card">
    <div class="card-body">
        <div class="col-12" id="botonAprobar" >
            <input type="hidden" name="txtIdSolicitudDireccion" id="txtIdSolicitudDireccion">
            <button type="button" id="btnAutorizar" class="btn btn-secondary float-left" onclick='autorizarPedidoDireccion()' ><i class="mdi mdi-pencil"></i> REALIZAR ENTREGA DE MATERIALES</button>
        </div>
    </div>
