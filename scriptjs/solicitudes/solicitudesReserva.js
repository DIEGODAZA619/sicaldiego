...
{
    var enlace = base_url + "Solicitudes/Presolicitud_almacen/cargartablasMaterialesAlmacen";
...
function cargarMaterialesAcumulados()
{
   ...
   var enlace = base_url + "Solicitudes/Presolicitud_almacen/cargartablasMaterialesAcumulados";
...
{
    var enlace = base_url + "Solicitudes/Presolicitud_almacen/verificarMaterialSeleccionado";
    $.ajax({
        type: "POST",
        url: enlace,
...
function guardarIngreso()
{
    if (validardatos())
    {
        if(confirm('¿Estas seguro de registrar la cantidad de material?'))
        {
            ...
            var enlace = base_url + "Solicitudes/Presolicitud_almacen/guardarSolicitudMateriales";
...
function eliminarIngresoDetalles(id_solicitud)
{
    ...
    {
        var enlace = base_url + "Solicitudes/Presolicitud_almacen/eliminarSolicitudMaterial";
        $.ajax({
            type: "POST",
            url: enlace,
...
{   $('#solicitudModal').modal({backdrop: 'static', keyboard: false})
    $('#solicitudModal').modal('show');
    limpiarFormularioIngreso();
    var enlace = base_url + "Solicitudes/Presolicitud_almacen/getSolicitudMaterialesId";
    $.ajax({
        type: "POST",
        url: enlace,
        data: {id_sol: id_solicitud},
